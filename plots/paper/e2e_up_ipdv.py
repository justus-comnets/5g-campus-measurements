...
if __name__ == "__main__":
    ...
    save = "/home/justus/Pictures/plots/end2end/upload/"
    ...
    var_params.show_ipdv_cdf_multiple(nested_ipdv_lists, labels=nested_labels,
                                      categories=p.labels, show=args.show, paper=True, xlim=[-6.5, 6.5],
    ...
    var_params.show_ipdv_cdf_multiple(nested_ipdv_lists, labels=nested_labels,
                                      categories=p.labels, show=args.show, paper=True, xlim=[-2, 7],
