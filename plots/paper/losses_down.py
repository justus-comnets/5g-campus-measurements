...
def show_losses(nested_losses_e2e, nested_losses_core, labels=None, categories=None, xlabel=None, save=None,
    ...
    for c, losses_list in enumerate(nested_losses_e2e):
        ...
        for (loss_e2e, e2e_sum, loss_ran, loss_core, core_sum) in zip(losses_e2e_perc, losses_e2e_sum, losses_ran_perc,
                                                                      losses_core_perc, losses_core_sum):
            print("Cat: {}  Losses_e2e: {},{}  Losses_ran: {}  Losses_core: {},{}".format(categories[c], loss_e2e,
                                                                                          e2e_sum, loss_ran, loss_core,
                                                                                          core_sum))
...
if __name__ == "__main__":
    ...
    save = "/home/justus/Pictures/plots/end2end/download/losses"
